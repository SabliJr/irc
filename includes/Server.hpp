...
private:
  ...
  void handleNotice(Client *client, const std::string &cmd);
  ...
  bool canJoinChannel(Channel &channel, Client *client,
                      const std::string &password);
  void initBot();
  void handleBotCommand(Client *client, const std::string &target,
